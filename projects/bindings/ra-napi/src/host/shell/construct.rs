...
impl Shell {
    ...
    pub(super) fn with_match(
        ...
        Self {
            ...
            lobby_countries: Vec::new(),
            lobby_side_groups: Vec::new(),
            lobby_side_chromes: Vec::new(),
            lobby_preview_for: None,
            lobby_preview: None,
            score_backdrop: None,
            score_backdrop_for: None,
            score_backdrop_tried: false,
