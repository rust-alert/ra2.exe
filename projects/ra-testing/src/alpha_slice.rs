    ...
    AlphaSkirmishSlice {
        ...
        buildings: &[
            ...
            SliceBuilding {
                type_id: "GAPILE",
                side: "allied",
                role: SliceBuildingRole::Barracks,
                cost: 500,
                power: -20,
            },
            SliceBuilding {
            ...
            SliceBuilding {
                type_id: "GAWEAP",
                side: "allied",
                role: SliceBuildingRole::WarFactory,
                cost: 2000,
                power: -30,
            },
            SliceBuilding {
            ...
            SliceBuilding {
                type_id: "GAREFN",
                side: "allied",
                role: SliceBuildingRole::Refinery,
                cost: 2000,
                power: -50,
            },
            SliceBuilding {
