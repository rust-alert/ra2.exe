...
pub fn stock_country_ui() -> &'static [StockCountryUi] {
    &[
        ...
        StockCountryUi { id: "Cuba", load_screen: "ls800cuba.shp", load_screen_pal: "mpls.pal", flag: "djbi.pcx", load_brief_suffix: "CUBA" },
        StockCountryUi { id: "Cubans", load_screen: "ls800cuba.shp", load_screen_pal: "mpls.pal", flag: "djbi.pcx", load_brief_suffix: "CUBA" },
        StockCountryUi { id: "Arabs", load_screen: "ls800iraq.shp", load_screen_pal: "mpls.pal", flag: "arbi.pcx", load_brief_suffix: "IRAQ" },
        StockCountryUi { id: "Iraq", load_screen: "ls800iraq.shp", load_screen_pal: "mpls.pal", flag: "arbi.pcx", load_brief_suffix: "IRAQ" },
        StockCountryUi { id: "Iraqis", load_screen: "ls800iraq.shp", load_screen_pal: "mpls.pal", flag: "arbi.pcx", load_brief_suffix: "IRAQ" },
        StockCountryUi {
            id: "Africans",
