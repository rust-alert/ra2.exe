...
pub fn stock_side_chromes() -> &'static [StockSideChrome] {
    &[
        ...
        StockSideChrome {
            ...
            campaign_score_background: Some("sycrbkmd.shp"),
            campaign_score_transition: Some("sycrtmd.shp"),
            campaign_score_animation: Some("sycramd.shp"),
            campaign_score_palette: Some("yscore.pal"),
            eva_tag: Some("Yuri"),
