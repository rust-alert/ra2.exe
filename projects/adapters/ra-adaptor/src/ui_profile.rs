...
pub use ra_types::{dialog_template_0x6b, dialog_template_0x102, dialog_template_0xd5};

/// 构造当前壳层可用的 UI profile（尚未接资源链探测）。
pub fn shell_runtime_ui_profile() -> RuntimeUiProfile {
    RuntimeUiProfile {
        dialog_templates: vec![dialog_template_0x6b(), dialog_template_0x102(), dialog_template_0xd5()],
