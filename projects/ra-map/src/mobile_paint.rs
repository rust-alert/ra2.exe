...
use ra_assets::{
    rasterize_vxl_layer_poses, HvaFile, IniDocument, Palette, ShpFile, VplFile, VxlFile,
    VxlLayerPose,
};
...
use crate::theater::{new_theater_shp_name, theater_palette};
...
mod tests {
    ...
    fn empty_mobiles_noop() {
        ...
        assert_eq!(
            paint_map_mobiles(&EmptySource, &map, &mut image, "art.ini", &|p, _| p.clone()),
            0
        );
    }
}
