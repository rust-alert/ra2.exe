...
pub use structure::{
    BuildCat, DEFAULT_BUILD_ADJACENT, HouseDefinition, HouseDefinitions, PowerProfile, ProduceCashProfile, StructureDefinition,
    StructureDefinitions, StructureLightProfile,
};
