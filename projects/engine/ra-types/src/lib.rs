...
pub use definition::{
    ...
    BuildCat, BuiltinCapability,
    CampaignName, CapabilitySet, ColorName, ContentFingerprint, DEFAULT_AI_BASE_SPACING, DEFAULT_AI_NAVAL_YARD_ADJACENCY,
    DEFAULT_AI_TRIGGER_WEIGHT, DEFAULT_BUILD_ADJACENT, DeployableDefinition, DeployableDefinitions, DeploymentPlacement, Foundation,
    GameModeName, HouseAllowList, HouseDefinition, HouseDefinitions, HouseIdAllowList, HouseName, HouseStolenTechMap, ImageName, LandType,
    LocomotorDefinitions, MAX_GUARD_RANGE_CELLS, MapAction, MapActionCommand, MapAiTrigger, MapCellTag, MapDefinition, MapEdge, MapEvent,
    MapEventCondition, MapFileName, MapHouse, MapIsoCell, MapLighting, MapLocalSize, MapOverlayCell, MapPlacedEntity, MapPlacedEntityKind,
    MapScriptStep, MapScriptType, MapSmudge, MapTag, MapTaskForce, MapTaskForceEntry, MapTeamType, MapTerrainObject, MapTrigger, MapWaypoint,
    MapWeatherKind, MissionKind, MissionName, OverlayName, OverlayTypeRegistry, PowerProfile, PreparedAction, PreparedActionCommand,
    ...
    WeaponName, armor_index, bind_map_actions, bind_map_ai_triggers, bind_map_cell_tags, bind_map_events, bind_map_houses, bind_map_placements,
    ...
    deserialize_optional_factory, ground_passable, land_passable, occupancy_kind, reseal_prepared_layers_from_placements,
    tmp_terrain_to_land_type, validate_placement_geometry,
};
