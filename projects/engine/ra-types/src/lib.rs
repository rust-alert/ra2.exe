...
pub use definition::{
    ...
    ImageName, LocomotorDefinitions, MapDefinition, MapLocalSize, MapTerrainObject, MapWaypoint, OverlayTypeRegistry, PowerProfile,
    ...
    ProductionProfile, ProjectileDefinition,
