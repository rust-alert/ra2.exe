...
pub use definition::{
    ...
    OverlayTypeRegistry, PowerProfile, PreparedCellTag, PreparedMap, PreparedPlacement, PreparedTag, PreparedTrigger, PrerequisiteGroupKind,
    ...
    WeaponDefinitions, WeaponName, armor_index, bind_map_cell_tags, bind_map_placements, bind_map_tags, bind_map_triggers,
    bind_prepared_map_placements, deserialize_optional_factory, ground_passable, land_passable, occupancy_kind, tmp_terrain_to_land_type,
};
