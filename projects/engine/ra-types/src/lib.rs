...
pub use definition::{
    ...
    ImageName, LocomotorDefinitions, MapDefinition, MapLocalSize, MapPlacedEntity, MapPlacedEntityKind, MapTerrainObject, MapWaypoint,
    OverlayTypeRegistry, PowerProfile, PrerequisiteGroupKind, PrerequisiteGroups, PrerequisiteList, PrerequisiteToken, PreparedMap,
    ProductionCategory, ProductionDefinitions, ProductionProfile, ProjectileDefinition,
