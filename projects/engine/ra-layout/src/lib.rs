...
pub use reference::{
    ...
    cameo_visible_slot_count, hit_cameo_slot, mul_div_round, solve_battle_abort_confirm, solve_battle_abort_confirm_at, solve_battle_hud,
    ...
    battle_pause_background_size, battle_pause_rail_rect, solve_battle_pause_with_metrics,
};
pub use shell::*;
