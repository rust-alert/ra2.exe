...
pub use reference::{
    ...
    resolve_dialog_0x6b, resolve_dialog_template, right_rail_buttons_layout_tree, shell_design_size,
    DluRect, FontBaseUnits, LegacyReference, LegacyRole, LegacySource, MS_SANS_SERIF_8PT,
};
