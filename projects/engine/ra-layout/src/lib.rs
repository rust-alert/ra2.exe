...
pub use reference::{
    ...
    solve_campaign, solve_choose_map, solve_dialog_template, solve_exit_confirm, solve_load_screen,
    ...
    NETWORK_BUTTON_IDS, OPTIONS_CONTENT_IDS, COMMAND_BAR_H, COMMAND_BUTTON_W, COMMAND_LENDCAP_W,
    COMMAND_RENDCAP_W,
};
