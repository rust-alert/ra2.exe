...
pub use reference::{
    ...
    solve_battle_hud_with_metrics, solve_campaign, solve_choose_map, solve_dialog_template,
    solve_exit_confirm, solve_load_screen, solve_network_page, solve_options_page, solve_shell_page,
    solve_skirmish_lobby, BattleHudChromeMetrics, DluRect, FontBaseUnits, LegacyReference,
