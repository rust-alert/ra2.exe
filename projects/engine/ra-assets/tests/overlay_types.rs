...
fn missing_key_zero_shifts_gems_and_ore_like_retail() {
    ...
    let early = [
        "GASAND", "CYCL", "GAWALL", "BARB", "WOOD", "DUMMY", "DUMMY2", "DUMMY3", "DUMMY4", "DUMMY5", "DUMMY6", "DUMMY7",
        "DUMMY8", "DUMMY9", "DUMMY10", "DUMMY11", "DUMMY12", "V16", "V17", "V18", "DUMMY13", "DUMMY14", "FENC", "DUMMY15",
        "BRIDGE1", "BRIDGE2", "NAWALL",
    ];
