use ra_layout::{
    BattleHudChromeMetrics, RectPx, cameo_slot_rect, rect_px_from_snapshot, solve_battle_hud_with_metrics,
};
use ra_renderer::RgbaImage;

use super::decode::radar_open_frame_range;
use super::hit_test::{BattleHudHit, hit_at_with_chrome};
use super::render::{cameo_ready_flash_on, paint_cameo_progress_clock};
