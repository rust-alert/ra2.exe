...
use ra_layout::{
    ...
    SKIRMISH_TRACK_THUMB_W, SkirmishLobbyLayout, battle_hud_layout, campaign_layout, choose_map_layout,
    exit_confirm_layout, main_menu_layout, options_layout, battle_pause_menu_layout, single_player_layout,
