...
use crate::{
    ...
    skin::text::{
        ...
        blit_caption_top_left_clipped, blit_caption_top_right_clipped, blit_caption_wrapped, blit_text_colored,
        campaign_csf_label, campaign_difficulty_csf_key, campaign_title_csf_key, choose_map_csf_label,
        choose_map_static_csf_key, choose_map_title_csf_key, exit_confirm_csf_label, exit_confirm_prompt_csf_key,
        load_screen_brief_csf_key, load_screen_loading_csf_key, load_screen_name_csf_key, main_menu_csf_label,
        options_csf_label, options_dialog_csf_key, battle_pause_menu_csf_label, battle_pause_menu_fallback_label,
        skirmish_score_csf_label, skirmish_score_fallback_label, resolve_caption, resolve_csf_text,
...
use ra_layout::{
    ...
    SHELL_BASE_H, SHELL_BASE_W, BattleHudChromeMetrics, SKIRMISH_SCORE_BUTTON_IDS,
    choose_map_list_row_rect, choose_map_visible_rows, clamp_map_list_scroll, rect_px_from_snapshot,
