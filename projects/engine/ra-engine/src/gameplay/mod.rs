...
pub(crate) use definitions_query::{
    building_power, deploy_into_type, factory_matches_category, factory_matches_unit, forbidden_houses_forbids, is_agent, is_base_unit,
    is_capturable, is_construction_yard, is_engineer, is_harvester, is_power_plant, is_production_factory, is_radar, is_refinery, owner_allows,
    required_houses_allows, requires_power_plant, house_id_of, house_key_of, starting_mcv_type_for_house, type_id_of, type_key_of,
};
pub use powers::{
