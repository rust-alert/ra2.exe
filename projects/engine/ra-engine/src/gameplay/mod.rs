...
pub(crate) use definitions_query::{
    building_power, deploy_into_type, factory_matches_category, factory_matches_unit, is_agent, is_capturable, is_construction_yard,
    is_engineer, is_harvester, is_power_plant, is_production_factory, is_radar, is_refinery, owner_allows, requires_power_plant,
